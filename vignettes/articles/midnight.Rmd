...
To understand the output of `mid_reg()`, **midnight** provides S3 methods for MID models like `persp.mid()` and `ggmid.midimp()`, which is activated when `nightfall()` is called.
